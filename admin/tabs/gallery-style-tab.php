...
class WPSC_Dynamic_Gallery_Style_Tab extends WPSC_Dynamic_Gallery_Admin_UI
{	
	/**
	 * @var string
	 */
	...
	public function tab_data() {
		...
		$tab_data = array( 
			...
			'callback_function'	=> 'wpsc_dgallery_style_tab_manager',
		);
...
global $wpsc_dgallery_style_tab;
$wpsc_dgallery_style_tab = new WPSC_Dynamic_Gallery_Style_Tab();

/** 
 * wpsc_dgallery_style_tab_manager()
 * Define the callback function to show tab content
 */
function wpsc_dgallery_style_tab_manager() {
	global $wpsc_dgallery_style_tab;
	$wpsc_dgallery_style_tab->tab_manager();
}
