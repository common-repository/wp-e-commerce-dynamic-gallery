...
class WPSC_Dynamic_Gallery_Less
{
	public $plugin_name = 'wpsc_dynamic_gallery';
	public $css_file_name = 'wpsc_dynamic_gallery_pro';
	public $plugin_folder = WPSC_DYNAMIC_GALLERY_FOLDER;
	public $plugin_dir = WPSC_DYNAMIC_GALLERY_DIR;
...
$wpsc_dynamic_gallery_less = new WPSC_Dynamic_Gallery_Less();
?>
