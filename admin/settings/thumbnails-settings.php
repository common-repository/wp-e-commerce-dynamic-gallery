...
class WPSC_Dynamic_Gallery_Thumbnails_Settings extends WPSC_Dynamic_Gallery_Admin_UI
{
	...
	public function __construct() {
		...
		$this->form_messages = array(
				'success_message'	=> __( 'Thumbnails Settings successfully saved.', 'wp-e-commerce-dynamic-gallery' ),
				'error_message'		=> __( 'Error: Thumbnails Settings can not save.', 'wp-e-commerce-dynamic-gallery' ),
				'reset_message'		=> __( 'Thumbnails Settings successfully reseted.', 'wp-e-commerce-dynamic-gallery' ),
			);
	...
	public function subtab_data() {
		...
		$subtab_data = array( 
			...
			'label'				=> __( 'Image Thumbnails', 'wp-e-commerce-dynamic-gallery' ),
	...
	public function init_form_fields() {
     	...
     	$this->form_fields = apply_filters( $this->option_name . '_settings_fields', array(
			...
			array(  
				'name' 		=> __( 'Show thumbnails', 'wp-e-commerce-dynamic-gallery' ),
				'desc' 		=> __( 'YES to enable thumbnail gallery', 'wp-e-commerce-dynamic-gallery' ),
			...
			array(  
				'name' 		=> __( 'Single Image Thumbnail', 'wp-e-commerce-dynamic-gallery' ),
				'desc' 		=> __( "YES to hide thumbnail when only 1 image is loaded to gallery.", 'wp-e-commerce-dynamic-gallery' ),
			...
			array(  
				'name' 		=> __( 'Thumbnail width', 'wp-e-commerce-dynamic-gallery' ),
				'desc' 		=> 'px. '.__("Setting 0px will show at default 105px. Please use the disable thumbnails feature if you want to hide them.", 'wp-e-commerce-dynamic-gallery' ),
				'id' 		=> 'thumb_width',
				'type' 		=> 'text',
				'css' 		=> 'width:40px;',
				'default'	=> '105'
			...
			array(  
				'name' 		=> __( 'Thumbnail height', 'wp-e-commerce-dynamic-gallery' ),
				'desc' 		=> 'px. '.__("Setting 0px will show at default 75px. Please use the disable thumbnails feature if you want to hide them.", 'wp-e-commerce-dynamic-gallery' ),
				'id' 		=> 'thumb_height',
				'type' 		=> 'text',
				'css' 		=> 'width:40px;',
				'default'	=> '75'
			...
			array(  
				'name' 		=> __( 'Thumbnail spacing', 'wp-e-commerce-dynamic-gallery' ),
				'desc' 		=> 'px',
				'id' 		=> 'thumb_spacing',
				'type' 		=> 'text',
				'css' 		=> 'width:40px;',
